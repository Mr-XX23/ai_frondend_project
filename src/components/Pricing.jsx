  ...
  return (
    <section>
      ...
      <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <h2 className="mb-4 body_head_text">Designed for business teams like yours</h2>
          <p className="mb-5 desc_body">Here at Syno we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
      </div>
      <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow xl:p-8 ">
              ...
              <a href="#" className="text-black bg-primary-600 hover:bg-primary-700 font-bold text-sm px-5 py-2.5 text-center">Get started</a>
          </div>
